...
def predictor():
    df = pd.read_csv("data\\csv\\complete_data.csv")  # target variable is boolean : 1 means autorized, 0 means unknown
...
def verifyUser():
    ...
    engine.say("Say Hey jarvis when the recording starts")
    print("Say Hey! jarvis when the recording starts")
    ...
    df = pd.read_csv("data\\csv\\complete_data.csv")  # target variable is boolean : 1 means auhtorize, 0 means unknown
